...
export default function SignIn({ onForgotPasswordClick, onRegisterClick }) {
  ...
  return (
    <section >
      <h1 className="text-3xl text-center mt-6 font-bold  ">Login to your account</h1>
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl  ">
      <div className="relative w-1/2 h-full flex flex-col">
  
      </div>

        <div className="w-full md:w-[67%] lg:w-[90%] ">
